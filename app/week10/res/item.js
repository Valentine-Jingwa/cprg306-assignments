...
const Item = ({ name, quantity, image, onDelete }) => {
  ...
  return (
    <>
      <li className="bg-blue-200 hover:shadow-lg rounded-lg p-4 m-2 w-12/12 flex flex-col items-center justify-between">
        ...
        <div className="flex justify-center w-full">
          ...
          <button onClick={ViewMealIdeas} className="bg-gradient-to-r m-2 w-10 h-10 rounded from-purple-500 via-blue-500 to-blue-700 text-center text-white py-1">
        🍲  
      </button>
